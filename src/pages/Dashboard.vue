<template>
  <div class="dashboard">
    ...
    <Row :gutter="16">
      <Col :lg="6">
        <VmUserPreview
          :brief="dataUserPreview.brief"
          :property="dataUserPreview.property"
        ></VmUserPreview>
      </Col>
      <Col :lg="18">
    ...
    <Row :gutter="16">
      <Col :lg="16">
        <VmTimeline title="Timeline" :data="dataTimeline"> </VmTimeline>
      </Col>
      <Col :lg="8">
        ...
        <VmWeather class="vm-margin" :data="dataWeather"> </VmWeather>
      </Col>
    </Row>
  </div>
</template>
