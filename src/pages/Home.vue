<template>
  <div class="home">
      ...
      <Dropdown class="login-info" placement="bottom-end">
        ...
        <Dropdown-menu slot="list">
          <Dropdown-item divided
            ><i class="fa fa-key"></i>Log out</Dropdown-item
          >
          <Dropdown-item divided
            ><i class="fa fa-cog"></i>Setting</Dropdown-item
          >
        </Dropdown-menu>
      </Dropdown>
    </Row>
      ...
      >
        ...
        <Submenu name="DataTable">
          ...
          <Menu-item name="BasicTable">
            <router-link to="/basic-table"> Basic Table </router-link>
          </Menu-item>
          <Menu-item name="EditableTable">
            <router-link to="/editable-table"> Editable Table </router-link>
          </Menu-item>
        </Submenu>
        <Submenu name="Pages">
          <template slot="title">
          ...
          <Menu-item name="Lockscreen">
            <router-link to="/lockscreen"> Lockscreen </router-link>
          </Menu-item>
    ...
    <div class="main-content">
      ...
      <p class="vm-author">
        vue-manager designed by
        <a href="https://github.com/AndrewLiCode" target="_blank">Andrew Li</a>
      </p>
    </div>
  </div>
</template>
